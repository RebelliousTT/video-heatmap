...
from mka_resnet10 import mkaresnet50
...
def main():
    load_pretrain = 'checkpoint/0Resfomer_resnet50-0-k5_a16-1234_something_RGB_segment8_e1000/ckpt.best.pth.tar'
    ...
    model = mkaresnet0(num_classes=num_class, num_segments=args.num_segments, drop_rate=args.dropout, drop_path_rate=0.)
