...
parser.add_argument('--dataset', default ='something', type=str)
parser.add_argument('--modality', default ='RGB', type=str, choices=['RGB', 'Flow'])
parser.add_argument('--train_list', type=str, default="E:/dataset/v1/train_videofolder.txt")
parser.add_argument('--val_list', type=str, default="E:/dataset/v1")
...
# parser.add_argument('--resume', default='./checkpoint/Resformer_something_RGB_Resnet50+Transformer_avg_segment16_e1000/ckpt.pth.tar', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')

# parser.add_argument('--tune_from', type=str, default='', help='fine-tune from checkpoint')
parser.add_argument('--tune_from', type=str, default='ckpt.best.pth.tar', help='fine-tune from checkpoint')
# parser.add_argument('--tune_from', type=str, default='my_save_ckpt.pth.tar', help='fine-tune from checkpoint')
...
parser.add_argument('--non_local', default=True, action="store_true", help='add non local block')
